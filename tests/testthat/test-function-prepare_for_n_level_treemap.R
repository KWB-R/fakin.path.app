test_that("prepare_for_n_level_treemap() works", {
  ...
  #library(testthat)
  f <- fakin.path.app:::prepare_for_n_level_treemap
  f2 <- fakin.path.app:::prepare_for_n_level_treemap2
  ...
  # fakin.path.app:::plot_treemap(result_1)
  #
  # args <- fakin.path.app:::args_treemap(n_levels = 2)
  # kwb.utils::callWith(fakin.path.app:::plot_treemap, dtf = result_2, args)
})
